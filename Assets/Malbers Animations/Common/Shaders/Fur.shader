	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv1_FurNormal72 = packedInput.uv1.xy;
				...
				float2 uv1_FurMap212 = packedInput.uv1.xy;
				float dotResult25 = dot( PixelNormalWorld24 , LightDirection33 );
				float nDotL38 = dotResult25;
				float temp_output_50_0 = ( ( pow( max( sin( radians( ( ( _AnisotropyOffset + nDotH40 ) * 180.0 ) ) ) , 0.0 ) , _AnisotropyFalloff ) * tex2D( _FurMap2, uv1_FurMap212 ).r ) * nDotL38 );
				
				float2 uv1_FurMap14 = packedInput.uv1.xy;
				float4 tex2DNode4 = tex2D( _FurMap1, uv1_FurMap14 );
				
				surfaceDescription.BaseColor = ( temp_output_3_0 * clampResult96 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Albedo1 = packedInput.ase_texcoord2.xy;
				float4 temp_output_3_0 = ( tex2D( _Albedo, uv_Albedo1 ) * _Tint );
				float4 color92 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 lerpResult91 = lerp( ( temp_output_3_0 * _AO ) , color92 , packedInput.ase_color.r);
				float4 saferPower98 = abs( ( lerpResult91 + ( 1.0 - _AOPower ) ) );
				...
				float2 uv1_FurNormal72 = packedInput.ase_texcoord2.zw;
				float3 unpack72 = UnpackNormalScale( tex2D( _FurNormal, uv1_FurNormal72 ), _NormalPowerFur );
				unpack72.z = lerp( 1, unpack72.z, saturate(_NormalPowerFur) );
				float3 tex2DNode72 = unpack72;
				float2 uv_BodyNormal5 = packedInput.ase_texcoord2.xy;
				float3 unpack5 = UnpackNormalScale( tex2D( _BodyNormal, uv_BodyNormal5 ), _NormalPowerBody );
				unpack5.z = lerp( 1, unpack5.z, saturate(_NormalPowerBody) );
				float3 NormalMap63 = unpack5;
				float3 lerpResult74 = lerp( tex2DNode72 , NormalMap63 , float3( 0.5,0.5,0.5 ));
				...
				float dotResult39 = dot( PixelNormalWorld24 , HalfVector37 );
				float nDotH40 = dotResult39;
				float2 uv1_FurMap212 = packedInput.ase_texcoord2.zw;
				float dotResult25 = dot( PixelNormalWorld24 , LightDirection33 );
				float nDotL38 = dotResult25;
				float temp_output_50_0 = ( ( pow( max( sin( radians( ( ( _AnisotropyOffset + nDotH40 ) * 180.0 ) ) ) , 0.0 ) , _AnisotropyFalloff ) * tex2D( _FurMap2, uv1_FurMap212 ).r ) * nDotL38 );
				
				float2 uv1_FurMap14 = packedInput.ase_texcoord2.zw;
				float4 tex2DNode4 = tex2D( _FurMap1, uv1_FurMap14 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv1_FurMap14 = packedInput.ase_texcoord1.xy;
				float4 tex2DNode4 = tex2D( _FurMap1, uv1_FurMap14 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv1_FurNormal72 = packedInput.ase_texcoord3.xy;
				float3 unpack72 = UnpackNormalScale( tex2D( _FurNormal, uv1_FurNormal72 ), _NormalPowerFur );
				unpack72.z = lerp( 1, unpack72.z, saturate(_NormalPowerFur) );
				float3 tex2DNode72 = unpack72;
				...
				float dotResult39 = dot( PixelNormalWorld24 , HalfVector37 );
				float nDotH40 = dotResult39;
				float2 uv1_FurMap212 = packedInput.ase_texcoord3.xy;
				float dotResult25 = dot( PixelNormalWorld24 , LightDirection33 );
				float nDotL38 = dotResult25;
				float temp_output_50_0 = ( ( pow( max( sin( radians( ( ( _AnisotropyOffset + nDotH40 ) * 180.0 ) ) ) , 0.0 ) , _AnisotropyFalloff ) * tex2D( _FurMap2, uv1_FurMap212 ).r ) * nDotL38 );
				
				float2 uv1_FurMap14 = packedInput.ase_texcoord3.xy;
				float4 tex2DNode4 = tex2D( _FurMap1, uv1_FurMap14 );
        ...
        Pass
        {
					...
					)
			{
				...
				float2 uv1_FurMap14 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode4 = tex2D( _FurMap1, uv1_FurMap14 );
...
Node;AmplifyShaderEditor.SamplerNode;1;-113.8526,-420.7391;Inherit;True;Property;_Albedo;Albedo;3;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;12;-767.949,776.9708;Inherit;True;Property;_FurMap2;Fur Map1 (Spec AO Trans);18;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;58;-291.669,75.74873;Inherit;True;Property;_Emission;Emission;8;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;4;638.727,162.5923;Inherit;True;Property;_FurMap1;Fur Map1 (A Height ID Root);17;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;145;0;89;0
WireConnection;145;1;74;0
WireConnection;145;7;71;0
WireConnection;145;9;4;1
ASEEND*/
//CHKSM=79F8D4893771987AC4EB02A865B93E778C3E8817