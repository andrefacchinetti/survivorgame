...
namespace UILibrary
{
    ...
    public class SlideToggle : BaseField<bool>
    {
        ...
        public SlideToggle(string label) : base(label, null)
        {
            ...
            // There are three main ways to activate or deactivate the SlideToggle.
            // All three event handlers use the static function pattern described in the Custom control best practices.
        ...
        // Because ToggleValue() sets the value property, the BaseField class dispatches a ChangeEvent.
        // This results in a call to SetValueWithoutNotify().
        // This example uses it to style the toggle based on whether it's currently enabled.
