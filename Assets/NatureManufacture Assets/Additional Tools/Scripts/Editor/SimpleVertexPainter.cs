...
public class SimpleVertexPainter : EditorWindow
{
    bool drawing = false;
    ...
    [MenuItem("Tools/Nature Manufacture/Simple Vertex Painter")]
    static void Init()
    {
        // Get existing open window or if none, make a new one:
        SimpleVertexPainter window = EditorWindow.GetWindow<SimpleVertexPainter>("Simple Vertex Painter");
        window.Show();
    }
