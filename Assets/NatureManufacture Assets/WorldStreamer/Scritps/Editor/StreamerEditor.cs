...
namespace WorldStreamer2
{
    ...
    class StreamerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            streamer.looping = EditorGUILayout.Toggle(new GUIContent("Looping", "Enable looping system, each layer is streamed independently, so if you want to synchronize them, they should have the same XYZ size. More info at manual."),
                streamer.looping);
            ...
            streamer.terrainNeighbours =
                (TerrainNeighbours) EditorGUILayout.ObjectField(
                    new GUIContent("Terrain Neighbours", "If you want to fix small holes from LODs system at unity terrain borders, drag and drop object here from scene hierarchy that contains our \"Terrain Neighbours\" script."),
