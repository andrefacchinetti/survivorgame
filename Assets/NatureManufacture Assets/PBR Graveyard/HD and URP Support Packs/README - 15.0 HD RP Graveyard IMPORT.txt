BEFORE YOU START:
- you need Unity  2023.1 or higher 
- you need HD SRP pipeline 15.0 if you use higher etc custom shaders could not work but seems they should. 
That's why we provide 15.0 version which seems to work with much higher versions aswell. 
For all higher RP versions please use 15.0 HD RP support pack.

!!!! IMPORTANT !!!!  We uploaded pack at 2023.1 and seams it have retarded baked gobal ilumination, we get strange results on few models. 
We turned off baked GI, try to bake it at higher versions like 2023.1 etc when they fix it. Bake will take few hours.
